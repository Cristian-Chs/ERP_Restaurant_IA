...
const RESTAURANT_PHONE_NUMBER = '584246188448'; // Número de WhatsApp (código de país + número)
...
function Carrito({ carrito, eliminarDelCarrito }) {
    ...
    const handleCheckout = () => {
        ...
        carrito.forEach((item, index) => {
            ...
            message += `${index + 1}. ${item.name} (${CURRENCY_SYMBOL}${price.toFixed(2)} c/u)\n`;
            message += `   Cantidad: ${item.cantidad} | Subtotal: ${CURRENCY_SYMBOL}${subtotal}\n`;
        });
